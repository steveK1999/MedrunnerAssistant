...
foreach ($screen in $screens) {
    ...
    $form.Add_Paint({
        ...
        # Background style - dark red with transparency
        $bgBrush = New-Object System.Drawing.SolidBrush([System.Drawing.Color]::FromArgb(30,205,0,0))
        ...
        if ($borderStyle -eq 'glow') {
            ...
            $pen = New-Object System.Drawing.Pen([System.Drawing.Color]::FromArgb(80,255,0,0), 4)
            $pointsLeft = @()
