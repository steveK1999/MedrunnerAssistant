...
function stringifyEnvFile(settings) {
	...
	const categories = {
		...
		sounds: ["CUSTOM_ALERT_SOUND", "CUSTOM_CHATMESSAGE_SOUND", "CUSTOM_TEAMJOIN_SOUND", "CUSTOM_UNASSIGNED_SOUND", "CUSTOM_ALERT_SOUND_DURATION_MS", "CUSTOM_CHATMESSAGE_SOUND_DURATION_MS", "CUSTOM_TEAMJOIN_SOUND_DURATION_MS", "CUSTOM_UNASSIGNED_SOUND_DURATION_MS"],
		features: [
		...
		overlay: ["OVERLAY_DURATION_MS", "OVERLAY_TEXT_SIZE_PERCENT", "OVERLAY_POSITION", "ALERT_OVERLAY_MONITOR_INDEX", "OVERLAY_BORDER_STYLE"],
