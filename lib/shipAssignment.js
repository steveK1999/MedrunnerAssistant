...
function renderShips() {
    ...
    container.innerHTML = ships.map(ship => `
        <div class="ship-card mb-4 rounded-lg border border-gray-600 bg-gray-800 p-4" data-ship-id="${ship.id}" ondrop="handleCrewDrop(event, ${ship.id})" ondragover="handleCrewDragOver(event)">
            <!-- Ship Header -->
